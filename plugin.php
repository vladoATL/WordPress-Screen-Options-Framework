...
/**
 * Screen Options demo plugin class.
 */
class WordPressScreenOptionsDemo {
	 ...
	 *
	 * @since  1.0.0
	 * @return WordPressScreenOptionsDemo A single instance of this class.
	 */
	...
	public function __construct() {
		...
		require_once dirname( __FILE__ ) . '/src/screen-options.php';
...
add_action( 'plugins_loaded', [ 'WordPressScreenOptionsDemo', 'get_instance' ] );
